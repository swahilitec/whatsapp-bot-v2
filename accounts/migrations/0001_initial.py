    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('manager', 'Club Manager'), ('player', 'Player'), ('coach', 'Coach'), ('parent', 'Parent'), ('referee', 'Referee'), ('admin', 'Site Admin')], max_length=30)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('password', models.CharField(max_length=100)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('reset_token', models.UUIDField(default=uuid.uuid4, editable=False, null=True, unique=True)),
