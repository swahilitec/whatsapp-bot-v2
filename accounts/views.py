...
class UserViewSet(viewsets.ModelViewSet):
    ...
    def users(self, request):
        ...
        return Response({"Users list":serializer.data}, status=status.HTTP_200_OK)
    ...
    def register(self, request):
        ...
        return Response({"message": "Account successfully created", "data": serializer.data},  status=status.HTTP_201_CREATED)
